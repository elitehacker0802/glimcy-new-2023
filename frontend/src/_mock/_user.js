...
export const _userAbout = {
  ...
  snapchatLink: `https://www.snapchat.com/caitlyn.kerluke`,
};
...
export const _userApis = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  cardNumber: ['**********awdq32f2', '**********awfrtyf2', '**********awddg2f2','**********awddg2f2'][index],
  cardType: ['binance', 'bybit', 'exmo', 'exmo1'][index],
}));
